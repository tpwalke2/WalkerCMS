...
'ConfigMerger'                          => path('app') . 'helpers/configmerger.php',
'ConfigValidator'                       => path('app') . 'helpers/configvalidator.php',
...
'ICache'                                => path('app') . 'helpers/icache.php',
'IConfigAdapter'                        => path('app') . 'helpers/iconfigadapter.php',
'IConfigMerger'                         => path('app') . 'helpers/iconfigmerger.php',
'IConfigValidator'                      => path('app') . 'helpers/iconfigvalidator.php',
