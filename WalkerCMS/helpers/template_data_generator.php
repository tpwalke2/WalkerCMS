...
class TemplateDataGenerator implements IDataGenerator
{
 ...
 public function generate_data($pages, $current_page, $content_source_page)
 {
  ...
  return array(
    ...
    'organization_slogan' => $this->_config->get('walkercms.organization_slogan', ''),
    'site_description' => $this->_config->get('walkercms.description'),
    'site_keywords' => $this->_config->get('walkercms.keywords'),
