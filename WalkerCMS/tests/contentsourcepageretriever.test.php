<?php
class ContentSourcePageRetrieverTest extends PHPUnit_Framework_TestCase
{
 ...
 public function testGetPage_UseLogger()
 {
  ...
  $result = $this->_retriever->get_page($this->_pages, $this->_current_page);
 }
...
/* End of file contentsourcepageretriever.test.php */
/* Location: ./WalkerCMS/tests/contentsourcepageretriever.test.php */