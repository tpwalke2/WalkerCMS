<?php
class FormsControllerTest extends PHPUnit_Framework_TestCase
{
 ...
 protected function setUp()
 {
  ...
  $this->_initial_result = array('submitting_page_id' => 'home', 'spam_control' => '');
  ...
  $this->_controller = new Forms_Controller(
 ...
 public function testPostContactSubmission_InvalidSubmission()
 {
  ...
  $this->assertEquals(array('response'), $this->_controller->post_form_submission());
  $this->assertEquals($this->_processed_result, $this->_context->get_form_data());
 }
 ...
 public function testPostContactSubmission_ClearFormValidationFromContext()
 {
  $this->_processed_result['processed'] = 'valid';
  ...
  $this->_response_retriever->expects($this->once())
                            ...
                            ->will($this->returnValue(array('response')));
  $this->assertEquals(array('response'), $this->_controller->post_form_submission());
  $this->assertEquals('default returned', $this->_context->get_form_validation('default returned'));
 }
 ...
 public function testPostContactSubmission_UseLogger()
 {
  ...
  $result = $this->_controller->post_form_submission();
 }
...
/* End of file forms_controller.test.php */
/* Location: ./WalkerCMS/tests/forms_controller.test.php */