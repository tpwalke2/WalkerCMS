<?php
class PagesConfigMergerTest extends PHPUnit_Framework_TestCase
{
 private $_merger = null;
 
 protected function setUp()
 {
  $this->_merger = new PagesConfigMerger();
 }
...
/* End of file pagesconfigmerger.test.php */
/* Location: ./WalkerCMS/tests/pagesconfigmerger.test.php */